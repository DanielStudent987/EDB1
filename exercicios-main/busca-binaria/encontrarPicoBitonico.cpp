 ...
 * @brief Encontra o ponto de pico em uma sequência bitônica, crescente ou decrescente usando busca binária.
 * 
...
/**
 * @brief Encontra um ponto de pico em uma sequência bitônica, crescente ou decrescente usando busca binária.
 *
 * @param arr O array de inteiros em ordem bitônica, crescente ou decrescente.
