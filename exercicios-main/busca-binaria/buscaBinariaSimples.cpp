...
/**
 * @brief Realiza uma busca binária recursiva em um intervalo do array.
 *
 * @param arr O array ordenado de inteiros.
 * @param inicio O primeiro índice do intervalo de busca.
 * @param fim O último índice do intervalo de busca.
